 ...
 * @async
 */
const appendFileAsync = async (path, data, mode) => await fsPromises.appendFile(path, data, { encoding: "utf8", mode });
 ...
 * @async
 */
const readFileAsync = async (path, mode) => await fsPromises.readFile(path, { encoding: "utf8", mode });
 ...
 */
const readFileStream = (path, mode) => fs.createReadStream(path, { encoding: "utf8", mode: mode });
